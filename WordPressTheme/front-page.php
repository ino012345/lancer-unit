...
<main>
  ...
  <section class="introduction">
    ...
    <figure class="introduction__arrow">
      <img src="<?php echo get_template_directory_uri(); ?>/assets/img/arrow@2x-100.jpg" alt="下向き矢印">
    </figure>
    <figure class="introduction__ok">
      <img src="<?php echo get_template_directory_uri(); ?>/assets/img/ok@2x-100.jpg" alt="LANCER UNITはどちらも解決可能。企業とクリエイターの働き方を支援しています。">
    </figure>
  </section>
  <section class="about">
  ...
  <section class="flow">
    <h1 class="flow__title">ランサーユニット利用までの流れ</h1>
  ...
  <section class="job">
    ...
    <p class="job__explain">現在も様々なジャンルのクリエイターの方にご登録をいただいております。もちろんクリエイターの業種は問いません。
ご自身の得意スキルはもちろん、チーム/ネットワークでカバーできる業務範囲まで登録可能です。</p>
  ...
  <section class="question" id="question">
    ...
    <ul class="accordion-area">
      <li>
        <section>
          <h3 class="title">登録に条件はありますか？</h3>
          <div class="box">
            <p>デジタルハリウッド（大学、大学院、東京本校、大阪校、STUDIO、オンラインスクール）で受講しているもしく修了している事が前提となります。</p>
          </div>
        </section>
      </li>
      <li>
